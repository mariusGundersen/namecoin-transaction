var namecoin = require('./main');


check(
  namecoin.newName('d/raid', '467e5b41d4bcb8c100', 'N2c1SDkTsPUiWsrtTxFUG32umhmKp3kdpo'),
...
check(
  namecoin.nameFirstUpdate('d/raid', '467e5b41d4bcb8c100', JSON.stringify({"ip":"212.232.51.96","email":"namecoin@mail.com","map":{"":"212.232.51.96","www":"212.232.51.96"}}), 'NDkrT5eEmMgfmZVxST6zqCQv62on4LNwYK'),
...
check(
  namecoin.nameUpdate('d/raid', JSON.stringify({"ip":"212.232.51.96","map":{"*":"212.232.51.96"},"email":"namecoin@mail.com"}), 'N7ykABB1KLSScMyinV7ZSapygpVKLMwTzL'),
